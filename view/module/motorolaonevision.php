                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            ...
                            <h3>$450.000 <span>550.000</span></h3> 
                                ...
                                <div class="tab-pane active" id="tabs-5" role="tabpanel">
                                    <div class="product__details__tab__content">
                                        ...
                                        <div class="product__details__tab__content__item">
                                            <center><h5>Pantalla</h5>
                                            <p>LTPS LCD de 5,9 pulgadas, Aspecto 19:9 Resolución de 1.520 x 720</p></center>
                                        </div>
                                        <div class="product__details__tab__content__item">
                                            <center><h5>Procesador</h5>
                                            <p>Snapdragon 625
                                                Ocho núcleos a 2GHz
                                                GPU Adreno 506</p></center>
                                        </div>
                                        <div class="product__details__tab__content__item">
                                            <center><h5>RAM</h5>
                                            <p>4GB</p></center>
                                        ...
                                        <div class="product__details__tab__content__item">
                                            <center><h5>Almacenamiento</h5>
                                            <p>64GB más microSD</p></center>
                                        </div>
                                        <div class="product__details__tab__content__item">
                                            <center><h5>Camaras Traseras</h5>
                                            <p>13 megapíxeles f/2.0
                                                2 megapíxeles
                                                Flash LED
                                                Vídeo 4K a 30fps</p></center>
                                        </div>
                                        <div class="product__details__tab__content__item">
                                            <center><h5>Camara Frontal</h5>
                                            <p>8 megapíxeles f/2.2
                                                Flash LED</p></center>
                                        </div>
                                        <div class="product__details__tab__content__item">
                                            <center><h5>Bateria</h5>
                                            <p>3.000 mAh
                                                Carga rápida TurboPower</p></center>
                                        </div>
                                        <div class="product__details__tab__content__item">
                                            <center><h5>Sistema</h5>
                                            <p>Android 8.1 One</p></center>
                                        </div>
                                        <div class="product__details__tab__content__item">
                                            <center><h5>Conectividad</h5>
                                            <p>WiFi 4
                                                Bluetooth 4.2
                                                radioFM
                                                USB tipo C
                                                Chip NFC
                                                GPS, GLONASS, Galileo</p></center>
                                        </div>
                                        <div class="product__details__tab__content__item">
                                            <center><h5>Dimensiones y Peso</h5>
                                            <p>150 x 72 x 7,97 milímetros
                                                197 gramos</p></center>
                                        </div>
                                    </div>
                                </div>
