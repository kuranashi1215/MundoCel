            ...
            <div class="row">
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="cart__price">$450.000</td>
                                ...
                                <tr>
                                    ...
                                    <td class="cart__price">$500.000</td>
                                    <td class="cart__close"><i class="fa fa-close"></i></td>
                                </tr>
                                <tr>
                                    <td class="product__cart__item">
                                ...
                                <tr>
                                    ...
                                    <td class="cart__price">$600.000</td>
                                    <td class="cart__close"><i class="fa fa-close"></i></td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="cart__total">
                        <h6>Carrito</h6>
                        <ul>
                            <li>Subtotal <span>$2.050.000</span></li>
                            <li>Total <span>$2.050.000</span></li>
                        </ul>
